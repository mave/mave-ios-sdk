...
@implementation MAVEInvitePageViewController {
    MAVEABTableViewController *abTableViewDelegate;
    MAVEInviteMessageViewController *inviteMessageViewDelegate;
}
...
- (UIView *)createContainerAndChildViews {
    ...
    abTableViewDelegate = [[MAVEABTableViewController alloc] initAndCreateTableViewWithFrame:tvf];
    inviteMessageViewDelegate = [[MAVEInviteMessageViewController alloc] initAndCreateViewWithFrame:imvf
