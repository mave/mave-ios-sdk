...
- (GRKInviteMessageViewController *)initAndCreateViewWithFrame:(CGRect)frame delegate:(GRKInvitePageViewController *)delegate selectedPhones:(NSMutableSet *)selectedPhones {
    self = [self init];
