...
- (void)testDataFromUint64 {
    NSString *output0 = [MAVEMerkleTreeHashUtils hexStringFromData:
                        [MAVEMerkleTreeHashUtils dataFromUInt64:0]];
    XCTAssertEqualObjects(output0, @"0000000000000000");
    NSString *output1 = [MAVEMerkleTreeHashUtils hexStringFromData:
                         [MAVEMerkleTreeHashUtils dataFromUInt64:1]];
    XCTAssertEqualObjects(output1, @"0000000000000001");
    NSString *output2 = [MAVEMerkleTreeHashUtils hexStringFromData:
                         [MAVEMerkleTreeHashUtils dataFromUInt64:UINT64_MAX]];
    XCTAssertEqualObjects(output2, @"ffffffffffffffff");
}
